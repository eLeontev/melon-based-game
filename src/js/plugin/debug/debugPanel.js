    ...
    patchSystemFn() {
        ...
        me.plugin.patch(me.Renderable, 'postDraw', function (renderer) {
            ...
            if (_this.visible) {
                ...
                if (
                    !(this instanceof me.Entity) &&
                    !(this instanceof me.Text) &&
                    !(this instanceof me.BitmapText) &&
                    !(this instanceof me.Camera2d) &&
